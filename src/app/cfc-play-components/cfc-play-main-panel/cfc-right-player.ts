...
export class RightPlayer {
    ...
    public modifyVitals (energy:number, motivation: number, credibility: number) : void {
        this.energy         += energy;
        this.motivation     += motivation;
        this.credibility    +=credibility;

        this.energy         = this.energy <0        ? 0 : this.energy >20 ?    20: this.energy;
        this.motivation     = this.motivation <0    ? 0 : this.motivation >20? 20: this.motivation;
        this.credibility    = this.credibility <0   ? 0 : this.credibility>20? 20: this.credibility;
    }
}